...
from catmaid.models import Dataset, ProjectDataset, DatasetStack, Project, DataView, Stack, ProjectStack
...
admin.site.register(ProjectDataset)
admin.site.register(DatasetStack)
