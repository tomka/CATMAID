...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('region_of_interest', (
            ...
            ('rotation_cw', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('catmaid', ['RegionOfInterest'])

        # Adding model 'RegionOfInterestClassInstance'
        db.create_table('region_of_interest_class_instance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Project'])),
            ('creation_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('edition_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('relation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.Relation'])),
            ('region_of_interest', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catmaid.RegionOfInterest'])),
